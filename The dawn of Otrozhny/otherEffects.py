...
class ChaosObject(pygame.Surface):
    def __init__(self, center, size, n_sides ):     
        ...
        self.points = mathHelpers.points_from_polygon_sides(n_sides,size/2, adjusted=True)
    ...
    def draw(self, screen):      
        ...
        self.updates_before_draw = 0
        screen.blit(self, (self.center[0] - self.size//2, self.center[1] - self.size//2))
    ...
    def update(self):
        ...
        newPx = mathHelpers.lerp(self.current_point[0], self.points[rand_pos][0], 0.5 )
        newPy = mathHelpers.lerp(self.current_point[1], self.points[rand_pos][1], 0.5 )
...
class StarField(pygame.Surface):
    ...
    def update(self, dt):
        ...
        for star in self.stars:
            ...
            star.screenX = mathHelpers.translate(star.x/star.z, 0, 1, 0, self.width)
            star.screenY = mathHelpers.translate(star.y/star.z, 0, 1, 0, self.height)
            star.screenX += self.width//2
            star.screenY += self.height//2

            star.screenLastX = mathHelpers.translate(star.x/star.lastZ, 0, 1, 0, self.width)
            star.screenLastY = mathHelpers.translate(star.y/star.lastZ, 0, 1, 0, self.height)
    ...
    def draw(self):
        ...
        for star in self.stars:       
            ...
            pygame.draw.line(self, (255,255,255), (star.screenX, star.screenY), (star.screenLastX, star.screenLastY), starSize)
